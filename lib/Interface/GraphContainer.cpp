...
// Overloading function for weighted graphs, currently assuming edges are of the
// same type as nodes
template <typename T, size_t N>
...
MemRef_descriptor Graph<T, N>::graph_to_MemRef_descriptor() {
  ...
  MemRef_descriptor sample_graph_memref = MemRef_Descriptor(
      this->allocated, this->aligned, this->offset, this->sizes, this->strides);
